...
|---|---|---|---|---|
| 测试 | `test` | `/root/ssc_fuyao_tg_app_test` | `ssc-offer-bot-test` | `测试1` / `测试2` / `测试3` / `测试4` / `测试4.1` / `测试11` / `测试21` / `测试6` / `测试6.1` / `测试6.2` / `测试7` / `测试5` / `测试9` / `测试91` / `测试92` |
| 生产 | `main` | `/root/ssc_fuyao_tg_app_prod` | `ssc-offer-bot-prod` | `1` / `2` / `3` / `4` / `4.1` / `11` / `21` / `6` / `6.1` / `6.2` / `7` / `5` / `9` / `91` / `92` |
